...
public class EditTeman extends AppCompatActivity {
    ...
    private  static String url_update = "http://10.0.2.2/umyTI/updateteman.php";
    private  static final String TAG = EditTeman.class.getSimpleName();
    private  static final String TAG_SUCCESS = "succcess";
        ...
        StringRequest stringReq = new StringRequest(Request.Method.POST, url_update, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (sukses == 1) {
                        Toast.makeText(EditTeman.this, "Suskses mengedit data", Toast.LENGTH_SHORT).show();
                    } else {
